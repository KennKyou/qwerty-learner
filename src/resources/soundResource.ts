...
export const wrongSoundResources: SoundResource[] = [{ key: '1', name: '聲音1', filename: 'beep.wav' }]

export const correctSoundResources: SoundResource[] = [{ key: '1', name: '聲音1', filename: 'correct.wav' }]
