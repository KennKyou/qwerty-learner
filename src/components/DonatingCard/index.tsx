...
export const DonatingCard = ({ className, onAmountChange }: { className?: string; onAmountChange?: (amount: AmountType) => void }) => {
  ...
  return (
    <div className={`flex w-full flex-col justify-center gap-3 ${className && className}`}>
      <h2 className="self-start font-bold text-gray-800 dark:text-gray-300">選擇您的贊助金額：</h2>
