      ...
      <div className="my-card relative z-10 flex h-[32rem] min-w-[26rem] select-text flex-col items-center justify-around rounded-2xl bg-white px-3 py-10 dark:bg-gray-900">
        ...
        <div className="item flex flex-col gap-4">
          <div className="flex gap-6">
            <DataTag icon={ClockIcon} name="平均用時" data={rowDetailData.time} />
            <DataTag icon={HashtagIcon} name="練習次數" data={rowDetailData.sumCount} />
          </div>
          <div className="flex gap-6">
            <DataTag icon={CheckCircle} name="正確次數" data={rowDetailData.correctCount} />
            <DataTag icon={XCircle} name="錯誤次數" data={rowDetailData.wrongCount} />
          </div>
        </div>
