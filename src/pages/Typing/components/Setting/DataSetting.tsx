      ...
      <ScrollArea.Viewport className="h-full w-full px-3">
        <div className={styles.tabContent}>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>資料匯出</span>
            <span className={styles.sectionDescription}>
              目前，使用者的練習資料<strong>僅保存在本地</strong>
              。如果您需要在不同的裝置、瀏覽器或者其他非官方部署上使用，您需要手動進行資料同步和保存。為了保留您的練習進度，建議您備份您的資料。
            </span>
            <span className="pl-4 text-left text-sm font-bold leading-tight text-red-500">
              為了您的資料安全，請不要修改匯出的資料文件。
            </span>
          ...
          <div className={styles.section}>
            <span className={styles.sectionLabel}>資料匯入</span>
            <span className={styles.sectionDescription}>
              請注意，匯入資料將<strong className="text-sm font-bold text-red-500"> 完全覆蓋 </strong>目前資料。請謹慎操作。
            </span>
