      ...
      <ScrollArea.Viewport className="h-full w-full px-3">
        <div className={styles.tabContent}>
          <div className={styles.section}>
            <span className={styles.sectionLabel}>字體設置</span>
            <div className={styles.block}>
              <span className={styles.blockLabel}>外語字體</span>
            ...
            <div className={styles.block}>
              <span className={styles.blockLabel}>中文字體</span>
              <div className="flex h-5 w-full items-center justify-between">
                <Slider.Root
          ...
          <button className="my-btn-primary ml-4 disabled:bg-gray-300" type="button" onClick={onResetFontSize} title="重置字體設置">
            重置字體設置
          </button>
        </div>
      </ScrollArea.Viewport>
